...
namespace townsend {
    namespace algorithm {
        ...
        template <typename String, typename RandomAccessIterator>
        void bwtDecode(String& bwtEncode, RandomAccessIterator key);
    }
}
...
template<class String, class RandomAccessIterator>
void townsend::algorithm::bwtDecode(String& bwtEncoded, RandomAccessIterator key) {
    using namespace std;
    RandomAccessIterator first = bwtEncoded.begin(), last = bwtEncoded.end();
    typename RandomAccessIterator::value_type empty = 0;
